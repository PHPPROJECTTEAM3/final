...
<html>
    ...
    <body class="margin5px">
        ...
        <button id="Print" style="float: right; margin-right: 125px;" class="btn btn-default"><span class="glyphicon glyphicon-print"></span></button>
        ...
        if (isset($_GET["current_month"])) {
            ...
            ?>
            <div id="hien1">
                <center><h3>Đợn Hàng Trong Tháng: <?php echo $month_now ?> Năm: <?php echo $year_now2 ?></h3></center>
                <center><table style="width: 80%" border="1" id="myTable" class="tablesorter">
                        <thead>
                            <tr>
                                <th >ID</th>
                                <th >Account</th>
                        ...
                        <tbody>
                            ...
                            while ($col = mysqli_fetch_array($result)) {
                                ...
                                if ($col[7] == "Chờ Xác Nhận") {
                                    $countCXN += 1;
                                }
                                if ($col[7] == "Đã Xác Nhận") {
                                    $countDXN += 1;
                                }
                            }
                            echo "<tbody></table></center>";

                            echo "<center><p>Đã Xác Nhận: <strong>$countDXN</strong><br/>Chờ Xác Nhận: <strong>$countCXN</strong><br/>Tổng: <strong>$count</strong></p></center><br/>";
                            ?>


                        <center><h3>Đơn Hàng Đã Hoàn Thành Trong Tháng: <?php echo $month_now ?> Năm: <?php echo $year_now2 ?></h3></center>
                        <center><table id="myTable2" border="1" class="tablesorter" style="width: 80%">
                                <thead>
                                    <tr>
                                        <th >ID</th>
                                        <th >Account</th>
                                ...
                                <tbody>
                                    ...
                                    echo "<center><p>Tổng: <strong>$count2</strong> <br/> Doanh Thu: <strong>$price2</strong>    VNĐ</p></center><br/></div>";
                                }
                                ?>
                                ...
                                <div id="hien1">
                                    ...
                                    <center><table border="1" id="myTable" class="tablesorter" style="width: 80%">
                                            <thead>
                                                <tr>
                                                    <th >ID</th>
                                                    <th >Account</th>
                                            ...
                                            <center><h3>Đơn Hàng Đã Hoàn Thành Trong Năm: <?php echo $year_now2 ?></h3></center>
                                            <center><table id="myTable2" border="1" class="tablesorter" style="width: 80%">
                                                    <thead>
                                                        <tr>
                                                            <th >ID</th>
                                        ...
                                        if (isset($_GET["bt_option"])) {
                                            ...
                                            ?>
                                            <div id="hien1">
                                                <center><h3>Các Đơn Hàng: <?php echo $option ?></h3></center>
                                                <center><table id="myTable" border="1" class="tablesorter" style="width: 80%">
                                                        <thead>
                                                            <tr>
                                                                <th >ID</th>
                                                                <th >Account</th>
                                                        ...
                                                        <center><h3>Các Đơn Hàng Đã Hoàn Thành: <?php echo $option ?> </h3></center>
                                                        <center><table id="myTable2" border="1" class="tablesorter" style="width: 80%">
                                                                <thead>
                                                                    <tr>
                                                                        <th >ID</th>
                                                        ...
                                                        echo "<center><p>Tổng: <strong>$count2</strong> <br/>Doanh Thu: <strong>$price2</strong>    VNĐ</p></center><br/>";
                                                    }
                                                    ?>
                                                    <script type="text/javascript">
                                                        ...
                                                        function PrintElem()
                                                        {
                                                            var divToPrint = document.getElementById("hien1");
                                                            newWin = window.open("");
